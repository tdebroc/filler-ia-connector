(function() {
    ...
    angular
        ...
        .factory('FillerSocketService', FillerSocketService);

    FillerSocketService.$inject = ['$rootScope', '$window', '$cookies', '$http', '$q'];
    ...
    function FillerSocketService ($rootScope, $window, $cookies, $http, $q) {
        ...
        function connect () {
            ...
            var url = '//' + loc.host + loc.pathname + 'websocket/filler';
